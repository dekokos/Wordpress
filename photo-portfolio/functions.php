...
function my_theme_load_resources() {
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/libs/bootstrap/css/bootstrap-theme.min.css', array(), '0.1' );	
	...
	wp_enqueue_script( 'jqueryjs', get_template_directory_uri() . '/libs/jquery/jquery-1.11.2.min.js', array(), '0.1', true ); //true - значит скрипты в подвале
